...
}); // 5700 // ab -c 400 -n 200000 http://localhost:3000/zero/params
 
app.get('/one/param/:first', function (req, res) {
  res.send(req.params.first);
}); // 5700 // ab -c 400 -n 200000 http://localhost:3000/one/param/first
 
app.get('/two/params/:first/:second', function (req, res) {
  res.send(req.params.first + req.params.second);
}); // 5550 // ab -c 400 -n 200000 http://localhost:3000/two/params/first/second
